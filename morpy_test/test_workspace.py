...
from morpy.const import NAMED_ELEMENT, MULTIPLICITY, MODEL, REFERENCE, PROPERTY,\
    ...
    UUID_MODEL, UUID_PROPERTY, UUID_REFERENCE
...
class MoRPTest(unittest.TestCase):
    ...
    def test_find_by_uuid(self):
        ...
        '''
        self.assertEqual(Workspace().get_by_uuid(UUID_MODEL), Workspace().model)
        self.assertEqual(Workspace().get_by_uuid(UUID_PROPERTY), Workspace().prop)
        self.assertEqual(Workspace().get_by_uuid(UUID_REFERENCE), Workspace().reference)
